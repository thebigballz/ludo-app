class Endpoints {
  ...
  static String rollDice(int gameId) => '/games/$gameId/roll';
  static String movePawn(int gameId) => '/games/$gameId/move';
  static String skipTurn(int gameId) => '/games/$gameId/skip';
}
